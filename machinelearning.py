...
# Memprediksi biaya iklan untuk target penjualan
...
print(f"Prediksi 50 sales: {predictions[0]:.2f} million $")
print(f"Prediksi 100 sales: {predictions[1]:.2f} million $")
print(f"Prediksi 150 sales: {predictions[2]:.2f} million $")
